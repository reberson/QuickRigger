...
from scripts.autorigger.rig_tools import rig_facial_mouth, rig_facial_cheek, rig_generic_chain, rig_arm, rig_facial_jaw, \
    rig_torso, rig_facial_tongue, rig_facial_nasolabial, rig_neck, rig_facial_eye, rig_facial_eyelid, rig_mesh_setup
from scripts.autorigger.shared.file_handle import file_dialog_yaml as fd
from scripts.autorigger.shared.file_handle import export_curve, import_curve
from scripts.autorigger.shared.skin_handler import save_selected_skin_yaml, load_selected_skin_yaml
...
def generate_menu():
    ...
    cmds.menuItem(p='layout', l='Load body template', stp='python',
                  c=lambda *args: layout_tools.joint_layout_create(
                      layout_tools.load_template_file('template_humanoid.yaml')),
                  ann='Load a template body rig structure')

    cmds.menuItem(p='layout', l='Load face template', stp='python',
                  c=lambda *args: layout_tools.joint_layout_create(
                      layout_tools.load_template_file('template_face.yaml')),
    ...
    # Rig face - rig_tools
    cmds.menuItem('facetools', p='face', l='Face rig_tools', subMenu=True, tearOff=True)
    ...
    # rig_tools ui
    cmds.menuItem('tools', p=menu_name, l='rig_tools', subMenu=True, tearOff=True)

    # rig_tools ui -- Actions
